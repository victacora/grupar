...
package com.inmovilizaciones.service;
...
import com.inmovilizaciones.Constants;
...
public class EnviarInmovilizacionService extends IntentService {
    ...
    public EnviarInmovilizacionService() {
    ...
    private ResultadoServicio<String> enviarInmovilizacion(Inmovilizacion inmovilizacion) {
        ...
        try {
            ...
            com.inmovilizaciones.webservice.modelo.Inmovilizacion inmovilizacionJSON = new com.inmovilizaciones.webservice.modelo.Inmovilizacion();
    ...
    public void onCreate() {
        ...
        try {
            ...
            mBuilder = new Notification.Builder(EnviarInmovilizacionService.this);
