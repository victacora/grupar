package com.inmovilizaciones.webservice.modelo;
...
public class Inmovilizacion {
    ...
    public String getPropietario_presente() {
        return this.propietario_presente;
    }
    ...
    public String getFec_ini_inm() {
        return this.fec_ini_inm;
    }

    public void setFec_ini_inm(String fec_ini_inm) {
